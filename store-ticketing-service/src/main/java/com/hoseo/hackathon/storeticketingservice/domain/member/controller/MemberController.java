package com.hoseo.hackathon.storeticketingservice.domain.member.controller;
...
import com.hoseo.hackathon.storeticketingservice.domain.member.controller.hateoas.MemberResource;
import com.hoseo.hackathon.storeticketingservice.domain.ticket.controller.hateoas.MyTicketResource;
import com.hoseo.hackathon.storeticketingservice.domain.member.controller.hateoas.StoreAdminResource;
...
public class MemberController {
    ...
    public ResponseEntity myTicket(Principal principal) {
        Ticket ticket = ticketService.findMyTicket(principal.getName());
    ...
    public ResponseEntity cancelMyTicket(Principal principal) {
        ticketService.cancelTicketByMember(principal.getName());
